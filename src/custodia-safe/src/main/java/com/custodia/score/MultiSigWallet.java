...
public class MultiSigWallet
{
    ...
    private final VarDB<Address> factory = Context.newVarDB("factory", Address.class);
     ...
     */
    public MultiSigWallet(String _walletOwners, BigInteger _required, Address _factory) {
    ...
    public void addWalletOwner(Address _walletOwner) {
        ...
        Context.call(factory.get(), "addOwner", _walletOwner, Context.getAddress());
    ...
    public void removeWalletOwner(Address _walletOwner) {
        ...
        Context.call(factory.get(), "removeOwner", _walletOwner, Context.getAddress());
